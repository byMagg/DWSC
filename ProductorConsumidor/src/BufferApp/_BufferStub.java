...
/**
 * BufferApp/_BufferStub.java . Generated by the IDL-to-Java compiler
 * (portable), version "3.2" from Buffer.idl martes 29 de noviembre de 2016
 * 10H32' CET
 */
...
public class _BufferStub extends org.omg.CORBA.portable.ObjectImpl implements BufferApp.Buffer {
	...
	public void setNoticias(int numeroMax) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request("setNoticias", true);
			$out.write_double(numeroMax);
			$in = _invoke($out);
	...
	private static String[] __ids = { "IDL:BufferApp/Buffer:1.0" };
