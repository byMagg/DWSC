		...
		try {
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					if (eElement.getElementsByTagName("nivelInteres").getLength() == 0)
						throw new Exception("Falta el nivelInteres");
					if (eElement.getElementsByTagName("descripcionCorta").getLength() == 0)
						throw new Exception("Falta la descripcionCorta");
